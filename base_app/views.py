...
from base_app.models import ApplicationUser, AdminUser, RenterRegisterRequests, RenterRegisterResults
...
def handle_reject_register_request(request: HttpRequest):
    if request.method == "POST":
        ...
        current_admin_user = AdminUser.objects.get(
            application_user = request.user
        )
...
def handle_accept_register_request(request: HttpRequest):
    if request.method == "POST":
        ...
        request_id = request.POST['request_id']
        register_request = RenterRegisterRequests.objects.get(
